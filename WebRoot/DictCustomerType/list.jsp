...
<% 
	...
	// 该功能对象实例 
	DictCustomerTypeObj domainInstance = (DictCustomerTypeObj) request.getAttribute("domainInstance"); 
	// 该功能路径 
			...
			<table class="search_table" align="center" width="98%"> 
				<tr> 
					<td align="left"> 
						...
						<input name="customer_type_code" type="text" id="customer_type_code" value="<%=StringUtil.getNotEmptyStr(domainInstance.getCustomer_type_code())%>" size="20" > 
						&nbsp;  
			...
			<table class="table table-bordered table-striped" align="center" width="98%"> 
				...
				<% 
					for (int i = 0; i < list.size(); i++) 
						{ 
							DictCustomerTypeObj o = (DictCustomerTypeObj) list.get(i); 
				%> 
				<tr> 
