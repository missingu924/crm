			...
			<table class="table table-bordered table-striped" align="center" width="100%">
				...
				<%
					...
					for (int i = 0; i < dataList.size(); i++)
					{
						...
						contractTotal += o.getContract_price() == null ? 0 : o.getContract_price();
						billTotal += o.getBill_money_total() == null ? 0 : o.getBill_money_total();
						gatherTotal += o.getGather_money_total() == null ? 0 : o.getGather_money_total();
						spareTotal += o.getSpare_money() == null ? 0 : o.getSpare_money();
				%>
				<tr>
