		...
		<form name="pageForm" id="pageForm" method="post" action="<%=request.getContextPath()%>/<%=basePath%>/Servlet?method=list4this"> 
			...
			<table class="search_table" align="center" width="98%" > 
				<tr> 
					...
					<td colspan="8" align="left"><input name="customer_full_name" type="text" id="customer_full_name" value="<%=StringUtil.getNotEmptyStr(domainInstance.getCustomer_full_name())%>" size="50" >				    </td>
			      <td align="right"><input name="addButton" type="button" class="button button_add" value="新增客户" onClick="winOpen('<%=contextPath%>/<%=basePath%>/Servlet?method=preModify4this')">
			        <input name="searchButton" type="button" class="button button_search" value="查询" onClick="toPage(1)"></td>
				</tr>
				<tr>
				  <td align="right"><%=domainInstance.getPropertyCnName("customer_type_code") %>&nbsp;&nbsp;<br></td>
				...
				<tr>
				  ...
				  <input name="service_due_date_start" type="text" id="service_due_date_start" value="<%=StringUtil.getNotEmptyStr(domainSearchCondition.getService_due_date_start())%>" size="11" onFocus="WdatePicker({isShowClear:false,readOnly:false,highLineWeekDay:true,dateFmt:'yyyy-MM-dd'})">-<input name="service_due_date_end" type="text" id="service_due_date_end" value="<%=StringUtil.getNotEmptyStr(domainSearchCondition.getService_due_date_end())%>" size="11" onFocus="WdatePicker({isShowClear:false,readOnly:false,highLineWeekDay:true,dateFmt:'yyyy-MM-dd'})"></td>
		          <td align="right"><%=domainInstance.getPropertyCnName("service_charge_peryear") %></td>
	              <td align="left"><input name="service_charge_peryear_min" type="text" id="service_charge_peryear_min" value="<%=StringUtil.formatDouble(domainSearchCondition.getService_charge_peryear_min(),2)%>" size="11">-<input name="service_charge_peryear_max" type="text" id="service_charge_peryear_max" value="<%=StringUtil.formatDouble(domainSearchCondition.getService_charge_peryear_max(),2)%>" size="11"></td>
			  </tr>
			</table> 
