...
<% 
	...
	// 该功能对象实例 
	DictProductVersionObj domainInstance = (DictProductVersionObj) request.getAttribute("domainInstance"); 
	// 该功能路径 
	...
	<body> 
		<form name="pageForm" id="pageForm" method="post" action="<%=request.getContextPath()%>/<%=basePath%>/Servlet?method=list4this"> 
			...
			<table class="table table-bordered table-striped" align="center" width="98%"> 
				<thead> 
					<tr> 
						<th><%=domainInstance.getPropertyCnName("version_code") %></th> 
						<th><%=domainInstance.getPropertyCnName("version_name") %></th> 
						<th>操作</th> 
					</tr> 
				</thead> 
				<% 
					for (int i = 0; i < list.size(); i++) 
						{ 
							DictProductVersionObj o = (DictProductVersionObj) list.get(i); 
				%> 
				<tr> 
					<td><%=StringUtil.getNotEmptyStr(o.getVersion_code())%></td> 
					<td><%=StringUtil.getNotEmptyStr(o.getVersion_name())%></td> 
