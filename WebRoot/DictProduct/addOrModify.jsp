...
<% 
	...
	// 对象实例 
	DictProductObj domainInstance = new DictProductObj(); 
	// 该功能基本路径 
	...
	{ 
		domainInstance = (DictProductObj) domainInstanceObj; 
	} 
 
	// 是否是修改 
	boolean isModify = domainInstance.getKeyValue() > 0; 
	// 唯一性检查用的字段 
	String keyCol = "product_code"; 
%> 
<html> 
	<head> 
		<base target="_self" /> 
		...
		<form name="addOrModifyForm" id="addOrModifyForm" action="<%=contextPath%>/<%=basePath%>/Servlet?method=addOrModify4this" method="post"> 
			...
			<table width="700" align="center" class="detail_table detail_table-bordered detail_table-striped"> 
				...
				<tr> 
					...
					<td> 
						<input name="product_code" type="text" id="product_code" value="<%=StringUtil.getNotEmptyStr(domainInstance.getProduct_code(),"")%>" size="20"  <%=isModify?"readOnly":""%>> 
						<font color="red">*</font> 
