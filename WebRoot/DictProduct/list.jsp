...
<%@page import="com.crm.obj.DictProductObj"%> 
<!-- 基本信息 --> 
<% 
	// 当前上下文路径 
	...
	// 该功能对象实例 
	DictProductObj domainInstance = (DictProductObj) request.getAttribute("domainInstance"); 
	// 该功能路径 
			...
			<table class="search_table" align="center" width="98%"> 
				<tr> 
					<td align="left"> 
						...
						<input name="product_code" type="text" id="product_code" value="<%=StringUtil.getNotEmptyStr(domainInstance.getProduct_code())%>" size="20" > 
						&nbsp;  
			...
			<table class="table table-bordered table-striped" align="center" width="98%"> 
				...
				<% 
					for (int i = 0; i < list.size(); i++) 
						{ 
							DictProductObj o = (DictProductObj) list.get(i); 
				%> 
				<tr> 
					<td><%=StringUtil.getNotEmptyStr(o.getProduct_code())%></td> 
