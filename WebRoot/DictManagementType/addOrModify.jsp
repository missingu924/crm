...
<% 
	...
	// 对象实例 
	DictManagementTypeObj domainInstance = new DictManagementTypeObj(); 
	// 该功能基本路径 
	...
	{ 
		domainInstance = (DictManagementTypeObj) domainInstanceObj; 
	} 
 
	// 是否是修改 
	boolean isModify = domainInstance.getKeyValue() > 0; 
	// 唯一性检查用的字段 
	String keyCol = "management_code"; 
%> 
<html> 
	<head> 
		<base target="_self" /> 
		...
		{	 
				// 做必要的检查 
		if(!checkNull("management_code","<%=domainInstance.getPropertyCnName("management_code")%>")) return false; 
		...
		<form name="addOrModifyForm" id="addOrModifyForm" action="<%=contextPath%>/<%=basePath%>/Servlet?method=addOrModify4this" method="post"> 
			...
			<table width="700" align="center" class="detail_table detail_table-bordered detail_table-striped"> 
				...
				<tr> 
					...
					<td> 
						<input name="management_code" type="text" id="management_code" value="<%=StringUtil.getNotEmptyStr(domainInstance.getManagement_code(),"")%>" size="20"  <%=isModify?"readOnly":""%>> 
						<font color="red">*</font> 
