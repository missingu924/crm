...
<%@page import="com.crm.obj.DictManagementTypeObj"%> 
<!-- 基本信息 --> 
<% 
	// 当前上下文路径 
	...
	// 该功能对象实例 
	DictManagementTypeObj domainInstance = (DictManagementTypeObj) request.getAttribute("domainInstance"); 
	// 该功能路径 
	...
	<body> 
		<form name="pageForm" id="pageForm" method="post" action="<%=request.getContextPath()%>/<%=basePath%>/Servlet?method=list4this"> 
			...
			<table class="search_table" align="center" width="98%"> 
				<tr> 
					<td align="left"> 
						<%=domainInstance.getPropertyCnName("management_code") %> 
						<input name="management_code" type="text" id="management_code" value="<%=StringUtil.getNotEmptyStr(domainInstance.getManagement_code())%>" size="20" > 
						&nbsp;  
			...
			<table class="table table-bordered table-striped" align="center" width="98%"> 
				<thead> 
					<tr> 
						<th><%=domainInstance.getPropertyCnName("management_code") %></th> 
						<th><%=domainInstance.getPropertyCnName("management_name") %></th> 
						<th>操作</th> 
					</tr> 
				</thead> 
				<% 
					for (int i = 0; i < list.size(); i++) 
						{ 
							DictManagementTypeObj o = (DictManagementTypeObj) list.get(i); 
				%> 
				<tr> 
					<td><%=StringUtil.getNotEmptyStr(o.getManagement_code())%></td> 
