...
<%@page import="com.crm.obj.DictSaleStageObj"%> 
<!-- 基本信息 --> 
<% 
	// 当前上下文路径 
	...
	// 该功能对象实例 
	DictSaleStageObj domainInstance = (DictSaleStageObj) request.getAttribute("domainInstance"); 
	// 该功能路径 
			...
			<table class="search_table" align="center" width="98%"> 
				...
				<td style="width:0"></td>
					<td align="left"> 
						...
						<input name="sale_stage_code" type="text" id="sale_stage_code" value="<%=StringUtil.getNotEmptyStr(domainInstance.getSale_stage_code())%>" size="20" > 
						&nbsp;  
						<%=domainInstance.getPropertyCnName("sale_stage_name") %> 
						<input name="sale_stage_name" type="text" id="sale_stage_name" value="<%=StringUtil.getNotEmptyStr(domainInstance.getSale_stage_name())%>" size="20" > 
						&nbsp;  
			...
			<table class="table table-bordered table-striped" align="center" width="98%"> 
				<thead> 
					<tr> 
						...
						<th><%=domainInstance.getPropertyCnName("sale_stage_name") %></th> 
						<th>操作</th> 
					</tr> 
				</thead> 
				<% 
					for (int i = 0; i < list.size(); i++) 
						{ 
							DictSaleStageObj o = (DictSaleStageObj) list.get(i); 
				%> 
				<tr> 
					<td><%=StringUtil.getNotEmptyStr(o.getSale_stage_code())%></td> 
					<td><%=StringUtil.getNotEmptyStr(o.getSale_stage_name())%></td> 
