...
<% 
	...
	// 对象实例 
	DictSaleStageObj domainInstance = new DictSaleStageObj(); 
	// 该功能基本路径 
	...
	{ 
		domainInstance = (DictSaleStageObj) domainInstanceObj; 
	} 
 
	// 是否是修改 
	boolean isModify = domainInstance.getKeyValue() > 0; 
	// 唯一性检查用的字段 
	String keyCol = "sale_stage_code"; 
%> 
<html> 
	<head> 
		<base target="_self" /> 
		...
		if(!checkNull("sale_stage_name","<%=domainInstance.getPropertyCnName("sale_stage_name")%>")) return false; 
		...
		<form name="addOrModifyForm" id="addOrModifyForm" action="<%=contextPath%>/<%=basePath%>/Servlet?method=addOrModify4this" method="post"> 
			...
			<table width="700" align="center" class="detail_table detail_table-bordered detail_table-striped"> 
				...
				<tr> 
					...
					<td> 
						<input name="sale_stage_code" type="text" id="sale_stage_code" value="<%=StringUtil.getNotEmptyStr(domainInstance.getSale_stage_code(),"")%>" size="20"  <%=isModify?"readOnly":""%>> 
						<font color="red">*</font> 
