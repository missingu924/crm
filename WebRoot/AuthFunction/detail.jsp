	...
	<body> 
		...
		<table width="700" align="center" class="detail_table detail_table-bordered detail_table-striped"> 
			...
			<tr> 
				...
				<td><%=StringUtil.getNotEmptyStr(domainInstance.getFunctioncode())%></td> 
			</tr> 
			<tr> 
				<td> 
					<%=domainInstance.getPropertyCnName("functionname") %>: 
				</td> 
				<td><%=StringUtil.getNotEmptyStr(domainInstance.getFunctionname())%></td> 
			</tr> 
			<tr> 
				<td> 
					<%=domainInstance.getPropertyCnName("functiondiscription") %>: 
				</td> 
				<td><%=StringUtil.getNotEmptyStr(domainInstance.getFunctiondiscription())%></td> 
			</tr> 
		</table> 
