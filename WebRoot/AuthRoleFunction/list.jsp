...
<%@page import="com.wuyg.auth.obj.AuthRoleFunctionObj"%> 
<!-- 基本信息 --> 
<% 
	// 当前上下文路径 
	...
	// 该功能对象实例 
	AuthRoleFunctionObj domainInstance = (AuthRoleFunctionObj) request.getAttribute("domainInstance"); 
	// 该功能路径 
			...
			<table class="search_table" align="center" width="98%"> 
				...
				<td style="width:0"></td>
					<td align="left"> 
						...
						<%=DictionaryUtil.getSelectHtml("权限项字典", "functioncode", StringUtil.getNotEmptyStr(domainInstance.getFunctioncode(), ""))%> 
						&nbsp;  
			...
			<table class="table table-bordered table-striped" align="center" width="98%"> 
				...
				<% 
					for (int i = 0; i < list.size(); i++) 
						{ 
							AuthRoleFunctionObj o = (AuthRoleFunctionObj) list.get(i); 
				%> 
				<tr> 
					<td> 
					...
					<td><%=DictionaryUtil.getDictValueByDictKey("权限项字典",o.getFunctioncode())%></td>  
