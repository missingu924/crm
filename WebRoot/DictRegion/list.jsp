...
<%@page import="com.crm.obj.DictRegionObj"%> 
<!-- 基本信息 --> 
<% 
	// 当前上下文路径 
	...
	// 该功能对象实例 
	DictRegionObj domainInstance = (DictRegionObj) request.getAttribute("domainInstance"); 
	// 该功能路径 
	...
	<body> 
		<form name="pageForm" id="pageForm" method="post" action="<%=request.getContextPath()%>/<%=basePath%>/Servlet?method=list4this"> 
			...
			<table class="search_table" align="center" width="98%"> 
				<tr> 
					<td align="left"> 
						<%=domainInstance.getPropertyCnName("region_code") %> 
						<input name="region_code" type="text" id="region_code" value="<%=StringUtil.getNotEmptyStr(domainInstance.getRegion_code())%>" size="20" > 
						&nbsp;  
						<%=domainInstance.getPropertyCnName("region_name") %> 
						<input name="region_name" type="text" id="region_name" value="<%=StringUtil.getNotEmptyStr(domainInstance.getRegion_name())%>" size="20" > 
						&nbsp;  
			...
			<table class="table table-bordered table-striped" align="center" width="98%"> 
				<thead> 
					<tr> 
						<th><%=domainInstance.getPropertyCnName("region_code") %></th> 
						<th><%=domainInstance.getPropertyCnName("region_name") %></th> 
						<th>操作</th> 
					</tr> 
				</thead> 
				<% 
					for (int i = 0; i < list.size(); i++) 
						{ 
							DictRegionObj o = (DictRegionObj) list.get(i); 
				%> 
				<tr> 
					<td><%=StringUtil.getNotEmptyStr(o.getRegion_code())%></td> 
					<td><%=StringUtil.getNotEmptyStr(o.getRegion_name())%></td> 
