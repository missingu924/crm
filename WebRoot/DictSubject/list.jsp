			...
			<table class="search_table" align="center" width="98%"> 
				<tr> 
					<td align="left"> 
						...
						<input name="subject_code" type="text" id="subject_code" value="<%=StringUtil.getNotEmptyStr(domainInstance.getSubject_code())%>" size="20" > 
						&nbsp;  
			...
			<table class="table table-bordered table-striped" align="center" width="98%"> 
				<thead> 
					<tr> 
						...
						<th><%=domainInstance.getPropertyCnName("subject_code") %></th> 
						<th><%=domainInstance.getPropertyCnName("subject_name") %></th> 
						<th>操作</th> 
					</tr> 
				</thead> 
				<% 
					for (int i = 0; i < list.size(); i++) 
						{ 
							DictSubjectObj o = (DictSubjectObj) list.get(i); 
				%> 
				<tr> 
					<td> 
					...
					<td><%=StringUtil.getNotEmptyStr(o.getSubject_code())%></td> 
